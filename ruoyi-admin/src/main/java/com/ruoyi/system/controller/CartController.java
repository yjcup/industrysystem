 ...
 */
@Controller
@RequestMapping("/platform/cart")
public class CartController extends BaseController
{
    private String prefix = "platform/cart";

    @Autowired
    private ICartService cartService;

    @RequiresPermissions("platform:cart:view")
    @GetMapping()
    public String cart()
    {
        return prefix + "/cart";
     ...
     * 查询购物车管理列表
     */
    @RequiresPermissions("platform:cart:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出购物车管理列表
     */
    @RequiresPermissions("platform:cart:export")
     ...
     * 新增保存购物车管理
     */
    @RequiresPermissions("platform:cart:add")
     ...
     * 修改购物车管理
     */
    @RequiresPermissions("platform:cart:edit")
    @GetMapping("/edit/{id}")
     ...
     * 删除购物车管理
     */
    @RequiresPermissions("platform:cart:remove")
